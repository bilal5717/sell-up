    ...
    <>
      <div className="container-fluid">
        <div className="row border">
          <div className="header-banner col-12 col-md-9 flex-grow relative w-full h-full rounded-lg">
          ...
          <div className="d-none d-md-block col-md-3 sideBanner mx-3 p-4 shadow-lg z-40 flex flex-col justify-center items-center">
