...
const LocationSidebar: React.FC = () => {
  ...
  const handleProvinceSelect = (province: string) => {
    ...
    setSelectedCity(null); // Reset city when changing province
    setIsLocationSelected(false); // Show city options
  };

  const handleCitySelect = (city: string) => {
    setSelectedCity(city);
    setIsLocationSelected(true); // Hide menu and show selected city only
  };
